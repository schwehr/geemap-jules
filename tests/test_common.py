    ...
    def test_ee_api_to_csv_success(self, mock_get):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with open(outfile, "r", encoding="utf-8") as f:
                ...
                self.assertEqual(lines[0].strip(), "name\tdescription\tfunction\treturns\targument\ttype\tdetails")
                self.assertEqual(lines[1].strip(), "TestName\t\tTestFunction()\tTestReturn\targ1|arg2\tType1|Type2\tDetail 1")
                self.assertEqual(lines[2].strip(), "TestName2\t\tTestFunction2()\tTestReturn2")
...
class TestTitilerEndpoint(unittest.TestCase):
    def test_init(self):
    ...
    def test_url_for_stac_item(self):
        endpoint = common.TitilerEndpoint()
    ...
    def test_url_for_stac_statistics(self):
        endpoint = common.TitilerEndpoint()
    ...
    def test_url_for_stac_pixel_value(self):
        endpoint = common.TitilerEndpoint()
    ...
    def test_url_for_stac_wmts(self):
        endpoint = common.TitilerEndpoint()
